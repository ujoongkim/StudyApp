...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn12_1).setOnClickListener(mClickListener);
        findViewById(R.id.btn12_2).setOnClickListener(mClickListener);
    ...
    Button.OnClickListener mClickListener = new Button.OnClickListener() {
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btn12_1:
                    Intent intent12_1 = new Intent(MainActivity.this, Ex12GameActivity.class);
                    startActivity(intent12_1);
                    break;

                case R.id.btn12_2:
                    Intent intent12_2 = new Intent(MainActivity.this, Ex12SoccerGameEx.class);
                    startActivity(intent12_2);
                    break;
